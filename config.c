                                     ...
                                     void *data, int event )
{
    ...
    if ( event == EVENT_REFRESH ) {
        ...
        { button = 2; }
            ...
            if ( conf_get_int ( conf, CONF_app_keypad ) )
            { button = 1; }
